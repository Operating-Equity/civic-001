...
export const config = {
  ...
  extractMaxOutputTokens: int('CIVIC_EXTRACT_MAX_OUTPUT_TOKENS', 16000),
  ...
  // Visual echo — the fast symbolic illustration generated while the document is processed.
  illustrateModels: list('CIVIC_IMAGE_MODELS', 'gpt-image-2.5-flare,gpt-image-1-mini'),
  illustrateQuality: env('CIVIC_IMAGE_QUALITY', 'low'),
