export default {
  ...
  step2: {
    ...
    gate: 'OpenAI permite a esta clave {limit} tokens por minuto y cuenta {cost} por cada determinación: {atOnce} empiezan a la vez y luego una más cada {every} s aproximadamente.',
