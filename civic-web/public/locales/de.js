export default {
  ...
  step2: {
    ...
    throttled: '{running} laufen · {n} warten auf das Minutenbudget des Schlüssels · {done} von {total} fertig · {time}',
    unreachable: '{running} laufen · {n} warten auf die Verbindung zu OpenAI · {why} · {done} von {total} fertig · {time}',
  ...
  card: {
    ...
    waitingConnection: 'Warten auf die Verbindung zu OpenAI · {why} · {time}',
    reconnecting: 'Die Verbindung zu CIVIC brach ab · neuer Versuch',
