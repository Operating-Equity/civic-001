...
export default {
  ...
  intake: {
    ...
    testing: 'Now testing',
    slow: 'The first step takes minutes on a long document, because the model reads it all before writing anything. The ten determinations then run three at a time, each taking a few minutes.',
