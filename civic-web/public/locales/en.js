...
export default {
  ...
  intake: {
    ...
    chars: '{n} characters',
    echo: 'Visual echo',
    echoHint: 'A quick symbolic image of the document, made on your key while it runs.',
    run: 'Test the facts',
    sample: 'Watch a sample run',
  ...
  score: { true: 'True', false: 'False', unverified: 'Unverified', tested: 'Tested', tokens: 'Tokens', cost: 'Est. cost', internal: 'Internal' },
  card: {
    pending: 'Queued',
  ...
  demo: {
    badge: 'Sample data',
    note: 'This is a sample run with placeholder results. Add a key to test real text.',
  },
  errors: {
  ...
  echo: { alt: 'Symbolic illustration of the document', making: 'Sketching what this is about…' },
