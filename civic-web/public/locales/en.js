...
export default {
  ...
  step2: {
    ...
    running: '{running} running at the same time · {done} of {total} done · {time}',
    throttled: '{running} running · {n} waiting for the key\'s minute budget · {done} of {total} done · {time}',
    gate: 'OpenAI allows this key {limit} tokens a minute and counts {cost} for each determination: {atOnce} start at once, then one more about every {every} s.',
