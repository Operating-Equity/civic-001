export default {
  ...
  step2: {
    ...
    running: '{running} en cours en même temps · {done} sur {total} terminées · {time}',
    throttled: '{running} en cours · {n} en attente du budget par minute de la clé · {done} sur {total} terminées · {time}',
    gate: 'OpenAI accorde à cette clé {limit} jetons par minute et en compte {cost} par détermination : {atOnce} démarrent en même temps, puis une de plus toutes les {every} s environ.',
