export default {
  ...
  step2: {
    ...
    throttled: '{running} en cours · {n} en attente du budget par minute de la clé · {done} sur {total} terminées · {time}',
    unreachable: '{running} en cours · {n} en attente de la connexion à OpenAI · {why} · {done} sur {total} terminées · {time}',
  ...
  card: {
    ...
    waitingConnection: 'En attente de la connexion à OpenAI · {why} · {time}',
    reconnecting: 'La connexion à CIVIC a été coupée · nouvelle tentative',
    retryBtn: 'Réessayer',
  ...
  errors: {
    ...
    key: 'OpenAI a refusé la clé de ce CIVIC. L\'opérateur doit la remplacer.',
    noKey: 'Ce CIVIC n\'a pas de clé OpenAI propre et ne fonctionnera avec celle de personne d\'autre. Ouvrez /check.',
    rate: 'OpenAI limite cette clé. Réessayez dans un instant.',
    checkLink: 'Pourquoi ?',
    url: 'Ce lien n\'a pas pu être lu : {message}',
    keyUnusable: 'La clé de ce CIVIC ne peut pas être envoyée dans une requête. Ouvrez /check pour voir pourquoi.',
